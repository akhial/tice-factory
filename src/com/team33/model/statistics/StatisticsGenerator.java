...
public class StatisticsGenerator {
    final int EVENT_NAME = 5;
    final int EVENT_CONTEXT = 3;
    ...
    public static void selectDates(String dateRef1, String dateRef2, String inputFile, String outputFile) throws IOException {
    ...
    public static void generalStats(String inputFile, String outputFile, int formatChoisi) throws IOException {
        XSSFWorkbook wb = null;
        String searcher = "";
        String reference = "";
        int occurence;
